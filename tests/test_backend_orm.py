...
import pandas as pd
from backend.modules.db_tools import write_db, read_db, Base, Quote
...
def override_session(monkeypatch, db_session):
    """Mock Session pour que write_db et read_db utilisent db_session"""
    from backend.modules import db_tools
